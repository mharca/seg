...
public class JanDevolver extends JFrame{
	...
	public JanDevolver(final List<String>lista) {
		...
		panel_1.setBorder(new TitledBorder(null, "Registrar devolu��o", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		panel_4.setBorder(new TitledBorder(null, "Descri��o", TitledBorder.LEADING, TitledBorder.TOP, null, null));
